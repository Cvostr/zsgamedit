...
bool ZSPIRE::Texture3D::pushTextureBuffer(int index, unsigned char* data){
     glBindTexture(GL_TEXTURE_CUBE_MAP, this->TEXTURE_ID);
...
bool ZSPIRE::Texture3D::pushTexture(int index, std::string path){
    std::ifstream texture_stream;
    texture_stream.open(path, std::ifstream::binary | std::ifstream::ate);
...
void ZSPIRE::Texture3D::Use(int slot){
